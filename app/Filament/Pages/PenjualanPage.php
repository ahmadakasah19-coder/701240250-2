...
class PenjualanPage extends Page implements HasForms, HasTable
{
    ...
    return [
        ...
        ->form([
          Select::make('pelanggan_id')
            ...
            ->options(Pelanggan::query()->pluck('name', 'id')) // Asumsi ada model Pelanggan
            ->searchable()
            ->required(),
          ...
          Repeater::make('items')
            ...
            ->schema([
              Select::make('barang_id')
                ->label('Nama Barang')
                ->options(Barang::query()->pluck('name', 'id'))
                ->searchable()
                ->required()
                ->reactive()
